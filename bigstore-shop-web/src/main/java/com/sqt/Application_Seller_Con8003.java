...
public class Application_Seller_Con8003 {
	private static final Logger logger = LoggerFactory.getLogger(Application_Seller_Con8003.class);
	public static void main(String[] args) {
		SpringApplication.run(Application_Seller_Con8003.class, args);
		logger.info("启动成功");
	}
}
